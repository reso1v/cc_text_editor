...
$(document).ready(function() {
    $("#downloadOutputTransparent").click(function() {
        ...
        try {
            ...
            console.log('Найден элемент output:', node);
            
            if (!node) {
                alert('Элемент предпросмотра не найден!');
                return;
            }
            ...
            console.log('Добавляем класс прозрачного фона');
            
            outputElement.addClass("transparent-bg");
            ...
            domtoimage.toBlob(node, {
                ...
                console.log('Изображение сгенерировано, размер blob:', blob.size);
                ...
                console.log('Сохраняем файл с именем:', filename);
                window.saveAs(blob, filename);
                
                outputElement.removeClass("transparent-bg");
                console.log('Файл сохранен успешно');
            }).catch(function(error) {
                console.error('Error при генерации изображения:', error);
